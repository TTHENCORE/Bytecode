...
local Themes = {
	Light = {
		MainFrame = Color3.fromRGB(230, 255, 230),
		Minimise = Color3.fromRGB(230, 255, 230),
		MinimiseAccent = Color3.fromRGB(230, 255, 230),
		Maximise = Color3.fromRGB(230, 255, 230),
		MaximiseAccent = Color3.fromRGB(230, 255, 230),
		NavBar = Color3.fromRGB(230, 255, 230),
		NavBarAccent = Color3.fromRGB(230, 255, 230),
		NavBarInvert = Color3.fromRGB(230, 255, 230),
		TitleBar = Color3.fromRGB(230, 255, 230),
		TitleBarAccent = Color3.fromRGB(230, 255, 230),
		Overlay = Color3.fromRGB(230, 255, 230),
		Banner = Color3.fromRGB(230, 255, 230),
		BannerAccent = Color3.fromRGB(230, 255, 230),
		Content = Color3.fromRGB(230, 255, 230),
		Button = Color3.fromRGB(230, 255, 230),
		ButtonAccent = Color3.fromRGB(230, 255, 230),
		ChipSet = Color3.fromRGB(230, 255, 230),
		ChipSetAccent = Color3.fromRGB(230, 255, 230),
		DataTable = Color3.fromRGB(230, 255, 230),
		DataTableAccent = Color3.fromRGB(230, 255, 230),
		Slider = Color3.fromRGB(230, 255, 230),
		SliderAccent = Color3.fromRGB(230, 255, 230),
		Toggle = Color3.fromRGB(230, 255, 230),
		ToggleAccent = Color3.fromRGB(230, 255, 230),
		Dropdown = Color3.fromRGB(230, 255, 230),
		DropdownAccent = Color3.fromRGB(230, 255, 230),
		ColorPicker = Color3.fromRGB(230, 255, 230),
		ColorPickerAccent = Color3.fromRGB(230, 255, 230),
		TextField = Color3.fromRGB(230, 255, 230),
		TextFieldAccent = Color3.fromRGB(230, 255, 230),
	},
	Dark = {
		MainFrame = Color3.fromRGB(0,0,0),
		Minimise = Color3.fromRGB(255,0,0),
		MinimiseAccent = Color3.fromRGB(147,59,0),
		Maximise = Color3.fromRGB(0,255,0),
